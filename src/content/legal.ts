  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'For clarity, and consistent with what the site says: One-Month Interaction Engine Design Sprint and Impact Build work is quoted as a fixed fee agreed in writing before work starts, and ongoing implementation work is charged as a flat monthly fee against a defined turnaround commitment. We do not bill by the hour. Fees are not published here because scope varies materially between clients.',
      ],
    },
    {
