...
export const background = {
  ...
  items: [
    ...
    },
    {
      ...
      body: 'Also the team behind DemandSpark. Running a product alongside the practice keeps the advice honest, because every recommendation is one we are living with somewhere ourselves.',
    },
  ],
}
